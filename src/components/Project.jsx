            ...
            <section>
                <div className='my-7 project flex flex-col gap-2'>
                    <header className=''>
                        ...
                        <p className='text-sm text-[#606060] md:text-base'>{description}</p>
                        <p className="text-sm md:text-base"><span className="font-medium text-[#4f4f4f]">Techstack:</span> {techstack.join(", ")}</p>
                    </header>
